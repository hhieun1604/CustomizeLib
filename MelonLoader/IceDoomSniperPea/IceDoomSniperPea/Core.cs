...
namespace IceDoomSniperPea
{
    public class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            IceDoomSniperPea.buff1 = CustomCore.RegisterCustomBuff("精装炸弹：冰毁炸弹爆炸的伤害x3，冰毁炸弹引爆后会为附近的僵尸挂上冰毁炸弹。2级时，每次引爆都造成寒冰毁灭菇爆炸，引爆时有50%概率触发超级爆头，并附带10%韧性的伤害", BuffType.AdvancedBuff, () => Board.Instance.ObjectExist<IceDoomSniperPea>(), 5000, plantType:(PlantType)IceDoomSniperPea.PlantID, level: 2, bg: CustomCore.BuffBgType.Night);
