...
namespace CustomizeLib.BepInEx
{
    ...
    {
        public static object Start(IEnumerator routine, MonoBehaviour behaviour)
        {
            return behaviour.StartCoroutine(routine);
        }

        public static void Stop(object routine, MonoBehaviour behaviour)
        {
            behaviour.StopCoroutine((Coroutine)routine);
        }
    }
